...
## Project Structure
    ...
    ├── dailysupportservice_37825  # Django project configurations
...
1. Clone this repo and `cd dailysupportservice_37825`
...
2. Clone this repo and `cd dailysupportservice_37825`
